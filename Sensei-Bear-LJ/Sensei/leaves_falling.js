allTypeOfLeaves = new Array(3)
Leaf1 =new Image();
Leaf1 = allTypeOfLeaves[0] = "images/maple.png";//path to the image you will use
Leaf2 =new Image();
Leaf2 = allTypeOfLeaves[1] ="images/maple1.png";//you can have up to 3 different kind of leaves
Leaf3 =new Image();
Leaf3 = allTypeOfLeaves[2] ="images/maple2.png";//possible to add more
Leaf4 =new Image();
Leaf4 = allTypeOfLeaves[3] ="images/maple3.png";
...
var typeOfLeaf = 4;//type of leav, 0 - maple leaf, 1 - saw leaf, 2 - normal leaf, 3 all types together
var fps = 60;
